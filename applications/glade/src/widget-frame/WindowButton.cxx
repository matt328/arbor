...
#include "WindowButtonPrivate.hpp"
...
auto WindowButton::iconNormal() const -> QIcon {
...
auto WindowButton::iconChecked() const -> QIcon {
  Q_D(const WindowButton);
...
auto WindowButton::iconDisabled() const -> QIcon {
  Q_D(const WindowButton);
