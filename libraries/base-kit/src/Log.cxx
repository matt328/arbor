...
void init() {
  ...
  Core->set_log_level(quill::LogLevel::TraceL3);
  Application->set_log_level(quill::LogLevel::TraceL3);
  Assets->set_log_level(quill::LogLevel::TraceL3);
  Renderer->set_log_level(quill::LogLevel::TraceL3);
  Resources->set_log_level(quill::LogLevel::TraceL3);
  Gameplay->set_log_level(quill::LogLevel::TraceL3);
}
